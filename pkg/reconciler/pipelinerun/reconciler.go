...
func (prf *PrFuncs) GetTTLSecondsAfterFinished(namespace, pipelineName string) *int32 {
...
func (prf *PrFuncs) GetSuccessHistoryLimitCount(namespace, name string) *int32 {
...
func (prf *PrFuncs) GetFailedHistoryLimitCount(namespace, name string) *int32 {
...
func (prf *PrFuncs) GetEnforcedConfigLevel(namespace, name string) config.EnforcedConfigLevel {
