...
// InitializeKnativeCompatibleMetrics is no longer used. We emit controller metrics via OTel on :9090.
func InitializeKnativeCompatibleMetrics(ctx context.Context) error { return nil }
